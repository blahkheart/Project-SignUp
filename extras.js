...
//Toggle remove-content class to 1st jumbotron column 
$('#psu-signup-btn').click(function ()  { $('#first-column').toggleClass('remove-content')})

//Remove col-md-6 class from 2nd jumbotron column to make it full width
$('#student-btn').click(function ()  { $('#second-column').removeClass('col-md-6')})